---
name: graphify
description: "Costruisci o interroga un knowledge graph persistente da una cartella di file (codice, docs, paper, immagini, video): god nodes, community detection, query/path/explain. Usala quando l'utente invoca /graphify, chiede esplicitamente un grafo della conoscenza, oppure quando esiste gia' un graphify-out/ per questo progetto e la domanda si risponde meglio interrogandolo. NON usarla come primo passo per una normale domanda su un codebase: per quello bastano Grep/Read/Explore."
---
